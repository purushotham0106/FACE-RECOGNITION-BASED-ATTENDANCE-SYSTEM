...
def capture_photo():
    ...
    while True:
        ...
        if k%256 ==27:
            ...
            file = 'D:/final\ImagesAttendance/'+str(s)+'.jpg'
...
def clock_in_details():
    os.startfile("D:/final/Clock_In.csv")
...
def clock_out_details():
    os.startfile("D:/final/Clock_Out.csv")
...
def send():
    ...
    try:
        msg = t13.get()
        account_sid = "ACfd75485451e2a705860f6887b88a9632"
        auth_token = "85d4890bcd5ed51d515bf53350a62aae"
